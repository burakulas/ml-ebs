#!/usr/bin/env python3
"""
Extract features from OGLE light curves and save as pickle.
Stripped from 4a_ogle_prediction.py — no model loading, no predictions.

Input:  OGLE light curve files (.csv/.dat) in OGLE_LC_DIR
Output: ogle_features.pkl  (dict with 'ids' and 'features' DataFrame)
"""
...
OUTPUT_PATH = os.path.join(WORK_DIR, "ogle_features.pkl")

BATCH_SIZE = 1000

# =============================================================================
# ROBUST LOADER (identical to 4a)
# =============================================================================
...
def main():
    ...
    print(f"Extracting features from {len(all_files)} OGLE files...")
